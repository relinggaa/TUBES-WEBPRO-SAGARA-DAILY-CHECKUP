...
import DaftarUserTable from '../../components/DaftarUserTable';
import GenerateKeyHeader from '../../components/GenerateKeyHeader';
...
export default function GenerateKey({ users = { data: [], links: [], current_page: 1, last_page: 1, total: 0 }, filters = { search: '', filter_role: 'all' } }) {
    ...
    return (
        <LayoutAdmin>
            {/* Flash Message */}
            {flash?.success && (
                <div className="mb-4 p-4 rounded-lg" style={{ backgroundColor: `${currentTheme.hex.primary}20`, border: `1px solid ${currentTheme.hex.primary}40` }}>
                    <p style={{ color: currentTheme.hex.secondary }}>{flash.success}</p>
                </div>
            )}
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs" style={{ color: `${currentTheme.hex.secondary}B3` }}>
                                                Buat kunci akses baru untuk user
                                            </p>
                                        </div>
                                    </div>
                                    <button
        ...
        <div>
                                ...
                                <div className="flex space-x-3 pt-2">
                                    ...
                                    <button
                                        type="submit"
                                        className="group/btn flex-1 px-4 py-3.5 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105 overflow-hidden relative"
                                        style={{
